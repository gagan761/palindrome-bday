...
var daysInMonth = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]; // 0 - 11
  ...
  // decrement the year if month is less than 1
  if(month < 1){
    month = 12;
    year--; 
  }
...
function clickHandler(e){
  ...
  if(bdayStr !== ''){
    ...
    if(isPalindrome){
      ...
      resultRef.innerText = `The prev palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed it by ${ctr} days! 😔`;
    }
  }
}
